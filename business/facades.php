    ...
    <div class="container">
        ...
        <div class="service-page__content">
            ...
            <div class="service-page__description">
                ...
                <h3>Что входит:</h3>
                <ul>
                    <li>Мойка фасада под давлением (гидроструйная очистка)</li>
                    <li>Удаление мха, лишайников и биологических загрязнений</li>
                    <li>Очистка карнизов, козырьков и водосточных труб</li>
                    <li>Мойка цоколя и ступеней входной группы</li>
