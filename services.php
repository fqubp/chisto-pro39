...
<section class="catalog">
    <div class="container">
        ...
        <div class="catalog__section">
            ...
            <div class="services-grid">
                <div class="service-card fade-in">
                    <div class="service-card__image"><i class="fas fa-building"></i></div>
                    <h3>Уборка офисов</h3>
                    <p class="price">от 40 руб/м²</p>
                    <a href="business/office.php" class="btn">Подробнее</a>
                </div>
                <div class="service-card fade-in">
                    <div class="service-card__image"><i class="fas fa-hard-hat"></i></div>
                    <h3>Уборка после ремонта</h3>
                    <p class="price">от 95 руб/м²</p>
                    <a href="business/after-renovation.php" class="btn">Подробнее</a>
                </div>
                <div class="service-card fade-in">
                    <div class="service-card__image"><i class="fas fa-spray-can"></i></div>
                    <h3>Химчистка ковровых покрытий</h3>
                    <p class="price">от 70 руб/м²</p>
                    <a href="business/cleaning.php" class="btn">Подробнее</a>
                </div>
                <div class="service-card fade-in">
                    <div class="service-card__image"><i class="fas fa-city"></i></div>
